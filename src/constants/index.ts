...
// Game Configuration
export const GAME_ROOM_MAX_PLAYERS = parseInt(
  process.env.GAME_ROOM_MAX_PLAYERS || '100',
  10,
);
export const GAME_DURATION_MINUTES = parseInt(
  process.env.GAME_DURATION_MINUTES || '30',
  10,
);

// Referral Configuration
export const REFERRAL_CODE_LENGTH = parseInt(
  process.env.REFERRAL_CODE_LENGTH || '5',
  10,
);
export const REFERRAL_REWARD_AMOUNT = parseInt(
  process.env.REFERRAL_REWARD_AMOUNT || '1000',
  10,
);
